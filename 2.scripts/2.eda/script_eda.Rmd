...
# load data
data <-
  readRDS(here::here("1.data", "4.data_for_analysis", "data_for_analysis.RDS"))
````
...
graph_wd_rainfall <- data %>%
  ...
  mutate(
    rainfall_duration = case_when(
      ...
      rainfall_duration == "[  1,  13)" ~ "[1, 13) minutes",
      rainfall_duration == "[ 13, 159)" ~ "[13, 159) minutes",
...
ggsave(
  graph_ridgeline_temperature,
  filename = here::here("3.outputs", "1.eda", "graph_ridgeline_temperature.pdf"),
  width = 30,
  height = 20,
  units = "cm",
  device = cairo_pdf
